...
def render_blog_cards(items: List[Dict[str, str]], height: int = 380) -> None:
    ...
    <style>
      .falowen-blog-outer {{
        max-width: 1120px; margin: 0 auto; width: 100%; padding: 0 8px;
      }}
      .falowen-blog-wrap {{
      ...
      .blog-card {{
        ...
        border-radius: 16px; text-decoration: none; border: 1px solid rgba(0,0,0,0.06);
      ...
      .card-title {{
        font-weight: 700; font-size: 15px; line-height: 1.2; margin-bottom: 6px; color: #0f172a;
        display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;
        overflow: hidden; text-overflow: ellipsis; min-height: 2.4em;
      }}
      .card-body {{
